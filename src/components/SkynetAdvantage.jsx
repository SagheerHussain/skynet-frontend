        ...
        <div className="container px-5">
          <div className="py-16 px-4 md:px-20 text-white">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-6">
              {/* Card 1 */}
              <motion.div
                className="bg-[#13151c] group transition-all duration-200 relative z-[0] overflow-hidden rounded-3xl w-[90%] md:w-1/3 px-6 py-8 text-center flex flex-col items-center transform scale-90 md:mt-10"
              >
